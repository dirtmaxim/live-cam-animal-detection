...
class Tracker:
    ...
    def delete(self, object_id):
        ...
        # Tracks.
        cv2.destroyWindow(f"Track: {object_id}")
...
class TrackedObject:
    def __init__(self, object_id, centroid, specie):
    ...
    def update(tracked_objects, animal):
        ...
        if tracked_object is None:
            tracked_object = TrackedObject(animal.object_id, animal.centroid, animal.specie)
        else:
